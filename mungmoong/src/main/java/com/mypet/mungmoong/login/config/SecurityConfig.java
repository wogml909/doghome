package com.mypet.mungmoong.login.config;
...
public class SecurityConfig  {
    ...
    @Autowired
    private CachingUserDetailsService customDetailsService;
    ...
    private AccessDeniedHandler accessDeniedHandler() {
        ...
        throw new UnsupportedOperationException("Unimplemented method 'accessDeniedHandler'");
    }
